# I handle NEO 2000 raw value translation here
...
#   7 (multiple)   -> 4 (DoubleSlotted)
#   8 (thin)       -> 2 (NotEmpty)
#   9 (failure)    -> 0 (Undefined)
#   anything else  -> 0 (Undefined) as a safe fallback
...
def translate_neo_2000(raw_values: list) -> list:
    ...
    # SlotOccupationState integers. I map unknown values to 0 (Undefined)
